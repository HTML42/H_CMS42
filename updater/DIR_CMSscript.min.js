setTimeout(function(){$(".update_trigger").click(function(){$.get("ajax/update.php",function(t){"1"===(t=$.trim(t))?(alert("Successfully updated from repository."),location.reload(!0)):"2"===t?(alert("Successfully updated from internal."),location.reload(!0)):alert("Update failed.")})})},1);
